 ...
 * {@link temperatura.OnFragmentInteractionListener} interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        consulta.setOnClickListener(new View.OnClickListener() {
            ...
            public void jsonParse(){
                ...
                String url = "http://arrau.chillan.ubiobio.cl:8075/ubbiot/web/mediciones/medicionespordia/WnDwB2ftck/E1yGxKAcrg/"+fecha;
                JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            temperaturapmm.append("Temperatura(Promedio,Maxima,Minima):"+"("+promedio+","+mayor+","+menor+")");
